...
public abstract class Color {
    ...
    protected static double RED_ORANGE_BORDER = 25;
    protected static double ORANGE_YELLOW_BORDER = 40;
    protected static double YELLOW_GREEN_BORDER = 80;
    protected static double GREEN_BLUE_BORDER = 170;
    protected static double BLUE_RED_BORDER = 280;
    protected static double MAX_COLOR = 360;
    ...
    public Color(String name, int index, double minH, double maxH, double minS, double maxS, double minV, double maxV) {
        this.name = name;
        this.index = index;
        this.minH = minH;
        this.maxH = maxH;
    ...
    public boolean isAcceptedColour(int R, int G, int B) {
        ...
        boolean h = minH <= HSV[0] && HSV[0] < maxH;
        return v && s && h;
    }
}
